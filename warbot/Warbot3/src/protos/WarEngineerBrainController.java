...
public class WarEngineerBrainController extends
	...
	public enum EngineerRole {
		UNKNOWN, GUARDIAN, TURRET_PRESSION;

		public boolean isUnknown() {
			return equals(UNKNOWN);
		}

		public static EngineerRole getBaseRoleByName(String string) {
	...
	public void defaultAttitude() {
		setAction(MovableWarAgent.ACTION_MOVE);
	}
