...
import edu.turtlekit3.warbot.game.MotherNatureTeam;
import edu.turtlekit3.warbot.game.Team;
import edu.turtlekit3.warbot.gui.WarViewer;
import edu.turtlekit3.warbot.maps.WarMap;
import edu.turtlekit3.warbot.teams.demo.WarBaseBrainController;
import edu.turtlekit3.warbot.teams.demo.WarEngineerBrainController;
import edu.turtlekit3.warbot.teams.demo.WarExplorerBrainController;
import edu.turtlekit3.warbot.teams.demo.WarKamikazeBrainController;
import edu.turtlekit3.warbot.teams.demo.WarRocketLauncherBrainController;
import edu.turtlekit3.warbot.teams.demo.WarTurretBrainController;
import edu.turtlekit3.warbot.tools.WarCircle;
import edu.turtlekit3.warbot.tools.WarIOTools;
import edu.turtlekit3.warbot.tools.WarXmlReader;
...
public class WarLauncher extends TKLauncher {
	...
	public static void getTeamsFromDirectoryCopy() {
	...
	public static void getTeamsFromDirectory() {
		...
		ImageIcon teamLogo = new ImageIcon("teams/logo.png");
		// On change sa taille
		Image tmp = teamLogo.getImage().getScaledInstance(50, 50, Image.SCALE_SMOOTH);
		teamLogo = new ImageIcon(tmp);
		...
		{
			Team currentTeam;
			currentTeam = new Team("Demolia");
			currentTeam.setDescription("Coucou");
			
			currentTeam.setLogo(teamLogo);
			
			currentTeam.addBrainControllerClassForAgent("WarBase", WarBaseBrainController.class);
			currentTeam.addBrainControllerClassForAgent("WarExplorer", WarExplorerBrainController.class);
			currentTeam.addBrainControllerClassForAgent("WarEngineer", WarEngineerBrainController.class);
			currentTeam.addBrainControllerClassForAgent("WarKamikaze", WarKamikazeBrainController.class);
			currentTeam.addBrainControllerClassForAgent("WarRocketLauncher", WarRocketLauncherBrainController.class);
			currentTeam.addBrainControllerClassForAgent("WarTurretBrainController", WarTurretBrainController.class);
		...
		{
			Team currentTeam;
			currentTeam = new Team("noe");
			currentTeam.setDescription("Coucou");
			
			currentTeam.setLogo(teamLogo);
			
			currentTeam.addBrainControllerClassForAgent("WarBase", edu.turtlekit3.warbot.teams.noe.WarBaseBrainController.class);
			currentTeam.addBrainControllerClassForAgent("WarExplorer", edu.turtlekit3.warbot.teams.noe.WarExplorerBrainController.class);
			currentTeam.addBrainControllerClassForAgent("WarEngineer", edu.turtlekit3.warbot.teams.noe.WarEngineerBrainController.class);
			currentTeam.addBrainControllerClassForAgent("WarKamikaze", edu.turtlekit3.warbot.teams.noe.WarKamikazeBrainController.class);
			currentTeam.addBrainControllerClassForAgent("WarRocketLauncher", edu.turtlekit3.warbot.teams.noe.WarRocketLauncherBrainController.class);
			currentTeam.addBrainControllerClassForAgent("WarTurretBrainController", edu.turtlekit3.warbot.teams.noe.WarTurretBrainController.class);
