...
public abstract class MovableWarAgent extends ControllableWarAgent implements Picker, Movable {
	 ...
	 * @param listAgent
	 *            Liste des ID des agents qui vont encercler l'unitï¿½e
	 * @param rayon
	 *            Rayon du l'encerclement
	 * @return Les coordonï¿½es polaire oï¿½ doit ce placer l'unitï¿½ courante pour
	 *         encercler l'untï¿½ passï¿½ en parametre. ATTENTION : si les
	 *         cooredonnï¿½es polaire sont ceux oï¿½ ce trouve deja l'unitï¿½ ca ne
	 *         sert a rien de ce dï¿½placer.
	 * 
	 */
	public CoordPolar circleThisEnemie(CoordPolar tank, ArrayList<Integer> listAgent, int rayon) {
		...
		if (tank.getDistance() < rayon) {
			// Mon positionement dans la liste des agents me permet de savoir oï¿½
			// je vais me placer
			...
			myAngle += 180;
			double deltaAngle = 5; // Pour eviter les tranblements des unitï¿½es
